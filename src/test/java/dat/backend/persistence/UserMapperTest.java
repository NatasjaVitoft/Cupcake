...
class UserMapperTest
{
    ...
    private final static String PASSWORD = "pllghp1d";
    ...
    {
        User expectedUser = new User("user", "1234", "user", "user", 1);
    ...
    {
        User newUser = UserFacade.createUser("jill", "1234", "user", "user", 1, connectionPool);
        User logInUser = UserFacade.login("jill", "1234", connectionPool);
        User expectedUser = new User("jill", "1234", "user", "user", 1);
